  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        success: {
          DEFAULT: "oklch(0.65 0.18 135)", // Bright green-teal (you can tweak)
          foreground: "oklch(0.15 0.02 250)", // Dark text
        },
        warning: {
          DEFAULT: "oklch(0.75 0.18 85)", // Yellow-orange
          foreground: "oklch(0.15 0.02 250)",
        },
        info: {
          DEFAULT: "oklch(0.65 0.19 260)", // Soft blue
          foreground: "oklch(0.98 0.01 250)", // White
        },
      },
